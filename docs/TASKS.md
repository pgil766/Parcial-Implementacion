...
- [ ] Reglas de negocio: no duplicados, tipo debe coincidir, posiciones de salida únicas
- [ ] Tests: inscribir competidor activo, rechazar suspendido, rechazar duplicado, rechazar tras deadline
